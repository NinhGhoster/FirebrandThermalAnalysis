...
classdef FlirMovieReader < handle
	...
	properties
		...
		applySuperframe;		% Collapse subframes into a superframe
		objectParameters;		% Object Parameter structure
		sourceInfo;             % File global information structure
	end
	...
	methods
		...
		function ret = get.applySuperframe(obj)
			ret = FlirMovieReaderMex('getApplySuperframe', obj.impl);
		end

		function obj = set.applySuperframe(obj, value)
			FlirMovieReaderMex('setApplySuperframe', obj.impl, value);
		end
		...
		function ret = get.sourceInfo(obj)
			ret = FlirMovieReaderMex('getSourceInfo', obj.impl);
		end
	end
end
